...
interface Usuario {
  ...
  fechaCreacion?: number; // Hacemos que sea opcional para coincidir con el esquema
  rol: string;
}
                ...
                <TableBody>
                  {usuarios.map((usuario) => (
                    <TableRow key={usuario._id}>
                      ...
                      <TableCell>{usuario.fechaCreacion ? new Date(usuario.fechaCreacion).toLocaleDateString() : 'N/A'}</TableCell>
