...
export default function DetalleEstudiantePage({
  ...
  const calificaciones = useQuery(
    api.calificaciones.obtenerCalificacionesPorEstudiante,
  ...
  const handleGuardarCalificacion = async () => {
    ...
    try {
      await crearCalificacion({
        ...
        materiaId: nuevaCalificacion.materiaId as Id<"materia">,
        semestre: nuevaCalificacion.semestre,
      });
      setNuevaCalificacion({ nota: 5, materiaId: "", semestre: "" });
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle className="text-2xl">{estudiante.nombre}</CardTitle>
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span className="text-sm">
                        {calificacion.materiaId || "Sin nombre"} (
      ...
      <Dialog open={modalEliminar} onOpenChange={setModalEliminar}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Esta acción no se puede deshacer. El estudiante será eliminado
      ...
      <Dialog open={modalCalificacion} onOpenChange={setModalCalificacion}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Ingresa los datos de la nueva calificación para{" "}
              {estudiante?.nombre}.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="nota">Calificación (5-10)</Label>
              <Input
                id="nota"
                name="nota"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="materiaId">ID de Materia</Label>
              <Input
                id="materiaId"
                name="materiaId"
                placeholder="ID de la materia"
                value={nuevaCalificacion.materiaId}
                onChange={handleChangeCalificacion}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={nuevaCalificacion.semestre}
                onChange={handleChangeCalificacion}
              />
            </div>
          </div>
